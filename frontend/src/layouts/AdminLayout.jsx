...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: "Tickets", icon: TicketCheck, to: "/admin/tickets" },
    ],
  },
  {
    label: "Management",
    items: [
      ...
      { label: "Offices", icon: Building2, to: "/admin/offices" },
      { label: "Systems", icon: Monitor, to: "/admin/systems" },
      { label: "Concern Types", icon: Tag, to: "/admin/concern-types" },
    ],
  },
];
...
const pageTitles = {
  ...
  "/admin/concern-types": "Concern Types",
};
...
const AdminLayout = () => {
  ...
  const pageTitle =
    ...
    Object.entries(pageTitles).find(
      ([key]) => location.pathname.startsWith(key) && key !== "/admin",
    )?.[1] ||
    "Dashboard";
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent
          side="left"
          className="w-56 p-0 border-r border-slate-200"
        >
          <VisuallyHidden>
